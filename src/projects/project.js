...
const project = () => {
  return (
    <div className='container-fluid d-flex justify-content-center align-items-center animate__animated animate__jello bg-project'>
    <div className='container-fluid d-flex justify-content-center align-items-center'>
      <div id="carouselExampleControls" className="carousel" data-bs-ride="carousel">
        ...
        <div className="carousel-item">
            ...
            <img src={ math } className="img-fluid" alt="Slide 3" />
            <div className="carousel-caption d-none d-md-block">  
            <div className="btn-group">
